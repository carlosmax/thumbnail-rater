...
export default function DashboardPage() {
  ...
  return (
    <div className="pt-12">
      <h1 className="text-center text-4xl font-bold mb-12">Your Thumbnail Tests</h1>
      ...
      {thumbnails && thumbnails.length === 0 && (
        <div className="flex flex-col items-center gap-8">
          <Image className="rounded-lg bg-white p-12" src="/void.svg" alt="no found icon" width="400" height="400" />
        ...
        {sortedThumbnails?.map((thumbnail) => {
          return (
            <Card key={thumbnail._id}>
              <CardHeader>
                <Image src={getImageUrl(thumbnail.aImage)} width="600" height="600" alt="thumbnail image" />
              </CardHeader>
              <CardContent>
                <p>{thumbnail.title}</p>
                <p>
